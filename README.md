...
Mit diesem Modul kann man eine Gastkundenaccount auf ein reguläres Kundenkonto umstellen
Folgende Funktionen bietet das Modul MITS_ChangeGuestToCustomer:

- Gastkundenkonto auf Knopfdruck zu einem Kundenkonto umwandeln
- Gastkundenkonto auf Knopfdruck zu einem Kundenkonto umwandeln und das generierte Password direkt dem Kunden zusenden

    
########################################################################################################

MITS_ChangeGuestToCustomer © by Hetfield (MerZ IT-SerVice) für modified eCommerce Shopsoftware
...
Anleitung für das Modul MITS_ChangeGuestToCustomer © by Hetfield (MerZ IT-SerVice)
========================================================================================================
...
Die Installation und Nutzung des Moduls MITS_ChangeGuestToCustomer erfolgt auf eigene Gefahr!

Die Installation des Moduls MITS_ChangeGuestToCustomer ist in der aktuellen Shopversion ab 2.x ziemlich einfach.
    ...
    2. Kopieren Sie anschließend einfach alle Dateien in dem Verzeichnis shoproot aus dem Modulpaket 
       MITS_ChangeGuestToCustomer in das Hauptverzeichnis ihrer bestehenden 
       modified eCommerce Shopsoftware 2.x Installation. Es werden dabei keine Dateien überschrieben!

    3. FERTIG!

--------------------------------------------------------------------------------------------------------
Wir hoffen, das Modul MITS_ChangeGuestToCustomer für die modified eCommerce Shopsoftware 2.x gefällt ihnen! 
